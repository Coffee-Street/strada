...
data class DrinkOptionDTO(
    ...
    constructor(id: Long?, hotOrIced: HotOrIcedType, cupType: CupType, cupSizeType: CupSizeType, waterType: WaterType, milkType: MilkType, icedOnlyType: IcedOnlyType, hotOnlyType: HotOnlyType, creamType: CreamType, memoType: MemoType, memo: String, shotCount: Int, syrupOptions: List<SyrupOptionDTO>, drizzleOptions: List<DrizzleOptionDTO>) : this(
        id ?: 0,
        hotOrIced,
        cupType,
        cupSizeType,
        waterType, milkType, icedOnlyType, hotOnlyType, creamType, memoType, memo, shotCount, syrupOptions, drizzleOptions
    )
}
